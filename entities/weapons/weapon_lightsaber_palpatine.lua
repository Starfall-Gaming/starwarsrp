...
SWEP.PrintName = "Palpatine's Lightsaber" --Name of the lightsaber
...
SWEP.ForcePowerList = { "Force Leap", "Channel Hatred", "Force Lightning", "Group Lightning", "Electric Judgement" } 
SWEP.DevestatorList = {  }
