...
SWEP.PrintName = "Vader's Lightsaber" --Name of the lightsaber
SWEP.Class = "weapon_lightsaber_vader" --The file name of this swep
...
SWEP.ForcePowerList = { "Force Leap", "Channel Hatred", "Force Choke", "Group Choke", "Saber Throw" } 
SWEP.DevestatorList = {  }
